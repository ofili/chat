...
// Methods called in run. The addClient and removeClient add and remove a conn from
// the pool (called clients in the struct) respectively
// The brodcastMessage method calls websocket's JSON.Send()
